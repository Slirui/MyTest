...
<body>
	<form action="saveAndUpdateMod.shtml" method="post">
		<div class="impwadd">
			<ul>
				<li>
					<p>入梅时间：</p>
					<div class="controls input-append date form_date" data-date=""
						...
						<input class="impwdate" type="text" name="modDay"
							value="${s:formatDate(modOrMei.modDay,'yyyy-MM-dd') }" readonly>
				...
				<li>
					...
					<div class="controls input-append date form_date" data-date=""
						data-date-format="yyyy-MM-dd" data-link-field="dtp_input2"
						data-link-format="yyyy-MM-dd">
						<input class="impwdate" type="text" name="meiDay"
							value="${s:formatDate(modOrMei.meiDay,'yyyy-MM-dd') }" readonly>
						<span class="add-on"><i class="icon-remove"></i></span> <span
							class="add-on"><i class="icon-th"></i></span>
					</div>
				</li>
				<li>
					<p>梅雨量：</p>
					<div class="controls">
						<input type="text" name="meiyuAmount"
							value="${modOrMei.meiyuAmount }">
					</div>
				</li>
		</div>
		<div class="btbtn">
