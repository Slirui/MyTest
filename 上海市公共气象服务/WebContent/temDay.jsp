...
<script src="js/highchart/dayCount.js" type="text/javascript"></script>
	...
	$(function() {
		...
		$("#export").click(
				function() {
					...
					location.href = "exportDayCount.shtml?dx="
...
<body>
	...
	<div class="sltresult">
		<div class="rsttitle">
			...
			<!-- <img id="change" src="images/change2.png" style="height: 50%; margin-top: -5px;"> -->
